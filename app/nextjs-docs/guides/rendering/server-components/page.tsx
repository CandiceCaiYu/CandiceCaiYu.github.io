...
import {
    ...
    serverRenderingStrategiesContent15Img,
    serverRenderingStrategiesContent16,
    serverRenderingStrategiesContent17,
...
const Page = () => {
    return (
        <>
            ...
            <CustomSection
                texts={[howAreServerComponentsRenderedTitle, howAreServerComponentsRenderedContent1, howAreServerComponentsRenderedContent2]}>
                <CustomList items={howAreServerComponentsRenderedContent2List}/>
            </CustomSection>
            <CustomSection goodToKnown={<GoodToKnown title={howAreServerComponentsRenderedContent3TipsTitle}
                                                     list={howAreServerComponentsRenderedContent3TipsList}
                                                     description={howAreServerComponentsRenderedContent3TipsDescription}/>}
                           texts={[howAreServerComponentsRenderedContent3]}>
                <CustomList items={howAreServerComponentsRenderedContent3List}/>
            </CustomSection>
            <Divider/>

            <CustomSection goodToKnown={<GoodToKnown title={serverRenderingStrategiesContent7TipsTitle}
                                                     list={serverRenderingStrategiesContent7TipsList}/>}
                           texts={[serverRenderingStrategiesTitle, serverRenderingStrategiesContent1, serverRenderingStrategiesContent2, serverRenderingStrategiesContent3, serverRenderingStrategiesContent4, serverRenderingStrategiesContent5, serverRenderingStrategiesContent6, serverRenderingStrategiesContent7,]}/>
            <CustomSection texts={[serverRenderingStrategiesContent8, serverRenderingStrategiesContent9]}/>
            <SectionWithTable
                columns={[
            ...
            />
            <CustomSection
                texts={[serverRenderingStrategiesContent10, serverRenderingStrategiesContent11, serverRenderingStrategiesContent12, serverRenderingStrategiesContent13,]}>
                <CustomList items={serverRenderingStrategiesContent13List}/>
            </CustomSection>
            <CustomSection image={{height: 260}}
                           texts={[serverRenderingStrategiesContent14, serverRenderingStrategiesContent14Img]}/>
            <CustomSection image={{height: 360}}
                           texts={[serverRenderingStrategiesContent15, serverRenderingStrategiesContent15Img, serverRenderingStrategiesContent16, serverRenderingStrategiesContent17]}/>
            <Divider/>
        </>
    )
}
