...
const Page = () => {
    return (
        <>
            ...
            <Divider/>
            <CustomSection texts={[caveatsContent1]}/>
            <SectionWithTable
