...
export const creatingRoutesContent2Image = "![URL段](/nextjsDoc/buildingYourApplication/routing/route-segments-to-path-segments.avif)";
export const creatingRoutesContent3 = "特殊文件page.js用来让路由给公众访问。";
export const creatingRoutesContent3Image = "![page.js](/nextjsDoc/buildingYourApplication/routing/defining-routes.avif)";
...
export const creatingRoutesContent5 = ".js, .jsx, 或.tsx文件扩展名可以用作特殊文件";
...
export const creatingUICode = `~~~export default function Page() {
