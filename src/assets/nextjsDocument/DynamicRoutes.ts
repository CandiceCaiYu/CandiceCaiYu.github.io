...
export const DynamicRoutesContent17 = '## TypeScript';
export const DynamicRoutesContent18 = '使用 TypeScript 时，您可以根据配置的路由段添加参数的类型。';
export const DynamicRoutesContent18Code = `~~~app/blog/[slug]/page.tsx
...
export const DynamicRoutesContent19Tips = '将来，这可能会由 TypeScript 插件自动完成。';
